...
export default function SolicitarPicking(){
...
{header:'Cantidad solicitada',field:'cantidad_solicitada'}
    ...
    const obtenerProductos=(sucursal_id:number)=>{
        apiService.CallAPI('GET',`/api/inventory/lista_productos_solicitar_picking?sucursal=${sucursal_id}`,{}).then((res:any)=>{
          if (res.status === 200){
    ...
    return (<>
    <h2>Lista de productos a solicitar en Picking</h2>
    <div>

...
export default function RecibirPicking(){
  ...
  const obtenerPickingProfile=(picking_id:string)=>{
   ...
   {header:'Cantidad enviada',field:'cantidad_enviada', type:'number'},
...
const download_pdf=()=>{
    ...
    <div className="stat-title">Unidades enviadas</div>

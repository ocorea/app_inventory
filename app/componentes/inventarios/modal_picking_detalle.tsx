...
export default function ModalPickingDetalle( {picking_id,show_modal_fnc,show_modal_value}:PickingDetalleProps){
    ...
    {header:'Cantidad enviada',field:'cantidad_enviada'},
    {header:'Cantidad pendiente',field:'cantidad_pendiente'}
];
 ...
 <dialog>
        ...
        >
            <div className="flex flex-col gap-4">
                <h1 className="title">Perfil de orden de picking {picking_id}</h1>
